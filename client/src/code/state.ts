...
export function createState(inParentComponent: React.Component): any {
  ...
  if (stateSingleton === null) {
    ...
    stateSingleton = {
      ...
      updateContactImageInState : function(updatedContact: Contacts.IContact): void {

        console.log("state.updateContactImageInState()", updatedContact);
      ...
      }.bind(inParentComponent) /* End updateContactImageInState(). */
